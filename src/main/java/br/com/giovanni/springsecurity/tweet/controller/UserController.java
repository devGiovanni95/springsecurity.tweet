...
import br.com.giovanni.springsecurity.tweet.controller.dto.CreateUserDto;
...
public class UserController {
    ...
    @PreAuthorize("hasAuthority('SCOPE_admin')") //no nosso banco de dados esta minusculo por isso temos que colocar minusculo aqui
